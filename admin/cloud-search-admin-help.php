...
define('WP_ACS_SCHEMA_LANGUAGE', '_en_default_');</pre>
            ...
            <p>
	            ...
	            <?php _e( 'You can provide a list of invalid chars (for example Unicode chars), separated by "|", that will be removed from your documents before syncing them into the CloudSearch index.', ACS::PREFIX ) ?><br />
