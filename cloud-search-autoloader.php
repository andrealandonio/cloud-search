...
if ( ! class_exists( 'WP_Cloud_Search_Autoloader' ) ) {

	class WP_Cloud_Search_Autoloader {
		...
		/**
		 * WP_Cloud_Search_Autoloader constructor.
		 *
		 * @param $prefix
		 * @param $abspath
		 *
		...
		protected function get_classes_directory() {
			return $this->abspath . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR;
		}
	}
}
