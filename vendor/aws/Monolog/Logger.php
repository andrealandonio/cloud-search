...
use WP_Cloud_Search\Monolog\Handler\HandlerInterface;
use WP_Cloud_Search\Monolog\Handler\StreamHandler;
use WP_Cloud_Search\Psr\Log\LoggerInterface;
use WP_Cloud_Search\Psr\Log\InvalidArgumentException;
/**
 * Monolog log channel
 *
 ...
 */
class Logger implements \WP_Cloud_Search\Psr\Log\LoggerInterface
{
    /**
     ...
     * @return $this
     */
    public function pushHandler(\WP_Cloud_Search\Monolog\Handler\HandlerInterface $handler)
    {
    ...
    {
        if (!$this->handlers) {
            $this->pushHandler(new \WP_Cloud_Search\Monolog\Handler\StreamHandler('php://stderr', static::DEBUG));
        }
    ...
    public static function getLevelName($level)
    {
        if (!isset(static::$levels[$level])) {
            throw new \WP_Cloud_Search\Psr\Log\InvalidArgumentException('Level "' . $level . '" is not defined, use one of: ' . \implode(', ', \array_keys(static::$levels)));
        }
