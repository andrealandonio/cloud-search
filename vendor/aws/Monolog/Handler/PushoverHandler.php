 ...
 */
class PushoverHandler extends \WP_Cloud_Search\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \WP_Cloud_Search\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \WP_Cloud_Search\Monolog\Logger::CRITICAL, $emergencyLevel = \WP_Cloud_Search\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \WP_Cloud_Search\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \WP_Cloud_Search\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
