 ...
 */
class BrowserConsoleHandler extends \WP_Cloud_Search\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \WP_Cloud_Search\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
