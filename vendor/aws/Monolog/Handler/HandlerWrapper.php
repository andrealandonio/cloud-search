 ...
 */
class HandlerWrapper implements \WP_Cloud_Search\Monolog\Handler\HandlerInterface
{
    /**
     ...
     */
    public function __construct(\WP_Cloud_Search\Monolog\Handler\HandlerInterface $handler)
    {
