 ...
 */
class CubeHandler extends \WP_Cloud_Search\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($url, $level = \WP_Cloud_Search\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    protected function connectUdp()
    {
        if (!\extension_loaded('sockets')) {
            throw new \WP_Cloud_Search\Monolog\Handler\MissingExtensionException('The sockets extension is required to use udp URLs with the CubeHandler');
        }
    ...
    private function writeHttp($data)
    {
        ...
        \WP_Cloud_Search\Monolog\Handler\Curl\Util::execute($this->httpConnection, 5, \false);
    }
}
