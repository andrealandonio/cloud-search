 ...
 */
namespace WP_Cloud_Search\Monolog\Processor;
...
class IntrospectionProcessor
{
    ...
    public function __construct($level = \WP_Cloud_Search\Monolog\Logger::DEBUG, array $skipClassesPartials = array(), $skipStackFramesCount = 0)
    {
        $this->level = \WP_Cloud_Search\Monolog\Logger::toMonologLevel($level);
