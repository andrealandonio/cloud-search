 ...
 */
class EventTest extends \WP_Cloud_Search\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->event = new \WP_Cloud_Search\Symfony\Component\EventDispatcher\Event();
        $this->dispatcher = new \WP_Cloud_Search\Symfony\Component\EventDispatcher\EventDispatcher();
    }
    /**
