 ...
 */
class TraceableEventDispatcher implements \WP_Cloud_Search\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcherInterface
{
    protected $logger;
    protected $stopwatch;
    private $called;
     ...
     */
    public function __construct(\WP_Cloud_Search\Symfony\Component\EventDispatcher\EventDispatcherInterface $dispatcher, \WP_Cloud_Search\Symfony\Component\Stopwatch\Stopwatch $stopwatch, \WP_Cloud_Search\Psr\Log\LoggerInterface $logger = null)
    {
     ...
     * {@inheritdoc}
     */
    public function removeSubscriber(\WP_Cloud_Search\Symfony\Component\EventDispatcher\EventSubscriberInterface $subscriber)
    {
     ...
     * {@inheritdoc}
     */
    public function dispatch($eventName, \WP_Cloud_Search\Symfony\Component\EventDispatcher\Event $event = null)
    {
        if (null === $event) {
     ...
     */
    protected function preDispatch($eventName, \WP_Cloud_Search\Symfony\Component\EventDispatcher\Event $event)
    {
    }
    /**
     ...
     * @param Event  $event     The event
     */
    protected function postDispatch($eventName, \WP_Cloud_Search\Symfony\Component\EventDispatcher\Event $event)
    {
    }
    private function preProcess($eventName)
    {
        foreach ($this->dispatcher->getListeners($eventName) as $listener) {
            ...
            $wrappedListener = new \WP_Cloud_Search\Symfony\Component\EventDispatcher\Debug\WrappedListener($listener, $name, $this->stopwatch, $this);
    ...
    private function postProcess($eventName)
    {
        ...
        $skipped = \false;
        foreach ($this->dispatcher->getListeners($eventName) as $listener) {
            if (!$listener instanceof \WP_Cloud_Search\Symfony\Component\EventDispatcher\Debug\WrappedListener) {
