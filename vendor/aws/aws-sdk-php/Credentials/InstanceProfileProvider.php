...
use WP_Cloud_Search\Aws\Exception\InvalidJsonException;
use WP_Cloud_Search\Aws\Sdk;
use WP_Cloud_Search\GuzzleHttp\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = isset($config['client']) ? $config['client'] : \WP_Cloud_Search\Aws\default_http_handler();
    }
    /**
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \WP_Cloud_Search\Aws\default_user_agent();
