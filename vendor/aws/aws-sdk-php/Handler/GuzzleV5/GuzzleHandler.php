...
use Exception;
use WP_Cloud_Search\GuzzleHttp\Client;
use WP_Cloud_Search\GuzzleHttp\ClientInterface;
use WP_Cloud_Search\GuzzleHttp\Event\EndEvent;
use WP_Cloud_Search\GuzzleHttp\Exception\ConnectException;
use WP_Cloud_Search\GuzzleHttp\Exception\RequestException;
use WP_Cloud_Search\GuzzleHttp\Message\ResponseInterface as GuzzleResponse;
use WP_Cloud_Search\GuzzleHttp\Promise;
use WP_Cloud_Search\GuzzleHttp\Psr7\Response as Psr7Response;
use WP_Cloud_Search\GuzzleHttp\Stream\Stream;
use WP_Cloud_Search\Psr\Http\Message\RequestInterface as Psr7Request;
