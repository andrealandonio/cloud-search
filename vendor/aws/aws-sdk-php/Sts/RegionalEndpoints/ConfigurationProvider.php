...
namespace WP_Cloud_Search\Aws\Sts\RegionalEndpoints;

use WP_Cloud_Search\Aws\AbstractConfigurationProvider;
use WP_Cloud_Search\Aws\CacheInterface;
use WP_Cloud_Search\Aws\ConfigurationProviderInterface;
use WP_Cloud_Search\Aws\Sts\RegionalEndpoints\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \WP_Cloud_Search\Aws\parse_ini_file($filename, \true);
            if ($data === \false) {
