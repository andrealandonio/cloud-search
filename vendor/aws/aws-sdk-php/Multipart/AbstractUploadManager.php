...
namespace WP_Cloud_Search\Aws\Multipart;

use WP_Cloud_Search\Aws\AwsClientInterface as Client;
use WP_Cloud_Search\Aws\CommandInterface;
use WP_Cloud_Search\Aws\CommandPool;
use WP_Cloud_Search\Aws\Exception\AwsException;
use WP_Cloud_Search\Aws\Exception\MultipartUploadException;
...
abstract class AbstractUploadManager implements Promise\PromisorInterface
{
    ...
    private static $defaultConfig = ['part_size' => null, 'state' => null, 'concurrency' => self::DEFAULT_CONCURRENCY, 'prepare_data_source' => null, 'before_initiate' => null, 'before_upload' => null, 'before_complete' => null, 'exception_class' => 'WP_Cloud_Search\\Aws\\Exception\\MultipartUploadException'];
