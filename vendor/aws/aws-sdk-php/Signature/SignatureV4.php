...
use WP_Cloud_Search\AWS\CRT\Auth\Signable;
use WP_Cloud_Search\AWS\CRT\Auth\SignatureType;
use WP_Cloud_Search\AWS\CRT\Auth\Signing;
use WP_Cloud_Search\AWS\CRT\Auth\SigningAlgorithm;
use WP_Cloud_Search\AWS\CRT\Auth\SigningConfigAWS;
use WP_Cloud_Search\AWS\CRT\Auth\StaticCredentialsProvider;
use WP_Cloud_Search\AWS\CRT\HTTP\Request;
use WP_Cloud_Search\Aws\Exception\CommonRuntimeException;
use WP_Cloud_Search\Aws\Exception\CouldNotCreateChecksumException;
