...
use WP_Cloud_Search\Aws\Api\Validator;
use WP_Cloud_Search\Aws\Api\ApiProvider;
use WP_Cloud_Search\Aws\Api\Service;
use WP_Cloud_Search\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use WP_Cloud_Search\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use WP_Cloud_Search\Aws\ClientSideMonitoring\Configuration;
use WP_Cloud_Search\Aws\Credentials\Credentials;
use WP_Cloud_Search\Aws\Credentials\CredentialsInterface;
use WP_Cloud_Search\Aws\Endpoint\PartitionEndpointProvider;
use WP_Cloud_Search\Aws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use WP_Cloud_Search\Aws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
use WP_Cloud_Search\Aws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use WP_Cloud_Search\Aws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use WP_Cloud_Search\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use WP_Cloud_Search\Aws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use WP_Cloud_Search\Aws\EndpointDiscovery\ConfigurationInterface;
use WP_Cloud_Search\Aws\EndpointDiscovery\ConfigurationProvider;
use WP_Cloud_Search\Aws\Exception\InvalidRegionException;
use WP_Cloud_Search\Aws\Retry\ConfigurationInterface as RetryConfigInterface;
use WP_Cloud_Search\Aws\Retry\ConfigurationProvider as RetryConfigProvider;
use WP_Cloud_Search\Aws\DefaultsMode\ConfigurationInterface as ConfigModeInterface;
use WP_Cloud_Search\Aws\DefaultsMode\ConfigurationProvider as ConfigModeProvider;
use WP_Cloud_Search\Aws\Signature\SignatureProvider;
use WP_Cloud_Search\Aws\Endpoint\EndpointProvider;
use WP_Cloud_Search\GuzzleHttp\Promise\PromiseInterface;
use WP_Cloud_Search\Aws\Credentials\CredentialProvider;
...
class ClientResolver
{
    ...
    {
        if ($value === \false) {
            $value = new Configuration(\false, \WP_Cloud_Search\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST, \WP_Cloud_Search\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT, \WP_Cloud_Search\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID);
            $args['csm'] = $value;
        }
    ...
    public static function _apply_endpoint_provider(callable $value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            ...
            $args['region'] = \WP_Cloud_Search\Aws\strip_fips_pseudo_regions($args['region']);
    ...
    public static function _apply_user_agent($inputUserAgent, array &$args, HandlerList $list)
    {
        ...
        if (\defined('WP_Cloud_Search\\HHVM_VERSION')) {
