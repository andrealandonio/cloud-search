...
function default_http_handler()
{
    ...
    if ($version === 6 || $version === 7) {
        return new \WP_Cloud_Search\Aws\Handler\GuzzleV6\GuzzleHandler();
    }
    // If Guzzle 5 installed
    if ($version === 5) {
        return new \WP_Cloud_Search\Aws\Handler\GuzzleV5\GuzzleHandler();
    }
...
function default_user_agent()
{
    ...
    // If Guzzle 6 or 7 installed
    if ($version === 6 || $version === 7) {
        return \WP_Cloud_Search\GuzzleHttp\default_user_agent();
    }
    // If Guzzle 5 installed
    if ($version === 5) {
        return \WP_Cloud_Search\GuzzleHttp\Client::getDefaultUserAgent();
    }
    throw new \RuntimeException('Unknown Guzzle version: ' . $version);
}
/**
...
function guzzle_major_version()
{
    ...
    if (\defined('\\WP_Cloud_Search\\GuzzleHttp\\ClientInterface::VERSION')) {
    ...
    } elseif (\defined('\\WP_Cloud_Search\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
