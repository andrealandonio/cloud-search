...
use WP_Cloud_Search\Aws\LruArrayCache;
use WP_Cloud_Search\Aws\Result;
use WP_Cloud_Search\Aws\S3\Exception\S3Exception;
use WP_Cloud_Search\GuzzleHttp\Psr7;
use WP_Cloud_Search\GuzzleHttp\Psr7\Stream;
use WP_Cloud_Search\GuzzleHttp\Psr7\CachingStream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \WP_Cloud_Search\Aws\flatmap($this->getClient()->getPaginator('ListObjects', $op), function (Result $result) use($filterFn) {
