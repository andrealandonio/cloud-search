...
use WP_Cloud_Search\Aws\Api\DocModel;
use WP_Cloud_Search\Aws\Api\Service;
use WP_Cloud_Search\Aws\AwsClient;
use WP_Cloud_Search\Aws\CacheInterface;
use WP_Cloud_Search\Aws\ClientResolver;
use WP_Cloud_Search\Aws\Command;
use WP_Cloud_Search\Aws\Exception\AwsException;
use WP_Cloud_Search\Aws\HandlerList;
use WP_Cloud_Search\Aws\InputValidationMiddleware;
use WP_Cloud_Search\Aws\Middleware;
use WP_Cloud_Search\Aws\Retry\QuotaManager;
use WP_Cloud_Search\Aws\RetryMiddleware;
use WP_Cloud_Search\Aws\ResultInterface;
use WP_Cloud_Search\Aws\CommandInterface;
use WP_Cloud_Search\Aws\RetryMiddlewareV2;
use WP_Cloud_Search\Aws\S3\UseArnRegion\Configuration;
use WP_Cloud_Search\Aws\S3\UseArnRegion\ConfigurationInterface;
use WP_Cloud_Search\Aws\S3\UseArnRegion\ConfigurationProvider as UseArnRegionConfigurationProvider;
use WP_Cloud_Search\Aws\S3\RegionalEndpoint\ConfigurationProvider;
use WP_Cloud_Search\GuzzleHttp\Exception\RequestException;
use WP_Cloud_Search\GuzzleHttp\Promise\Promise;
...
class S3Client extends AwsClient implements S3ClientInterface
{
    ...
    public function createPresignedRequest(CommandInterface $command, $expires, array $options = [])
    {
        ...
        $request = \WP_Cloud_Search\Aws\serialize($command);
    ...
    public function getObjectUrl($bucket, $key)
    {
        ...
        return (string) \WP_Cloud_Search\Aws\serialize($command)->getUri();
    }
    /**
    ...
    {
        if ($value) {
            $config = \WP_Cloud_Search\Aws\Retry\ConfigurationProvider::unwrap($value);
