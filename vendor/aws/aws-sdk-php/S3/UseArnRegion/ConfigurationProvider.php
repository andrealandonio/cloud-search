...
namespace WP_Cloud_Search\Aws\S3\UseArnRegion;
...
use WP_Cloud_Search\Aws\S3\UseArnRegion\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \WP_Cloud_Search\Aws\parse_ini_file($filename, \true, \INI_SCANNER_NORMAL);
            if ($data === \false) {
