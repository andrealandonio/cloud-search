...
use WP_Cloud_Search\Aws\Api\Serializer\QuerySerializer;
use WP_Cloud_Search\Aws\Api\Serializer\Ec2ParamBuilder;
use WP_Cloud_Search\Aws\Api\Parser\QueryParser;
/**
...
class Service extends AbstractModel
{
    ...
    {
        static $mapping = ['json' => 'WP_Cloud_Search\\Aws\\Api\\Serializer\\JsonRpcSerializer', 'query' => 'WP_Cloud_Search\\Aws\\Api\\Serializer\\QuerySerializer', 'rest-json' => 'WP_Cloud_Search\\Aws\\Api\\Serializer\\RestJsonSerializer', 'rest-xml' => 'WP_Cloud_Search\\Aws\\Api\\Serializer\\RestXmlSerializer'];
    ...
    {
        static $mapping = ['json' => 'WP_Cloud_Search\\Aws\\Api\\ErrorParser\\JsonRpcErrorParser', 'query' => 'WP_Cloud_Search\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'rest-json' => 'WP_Cloud_Search\\Aws\\Api\\ErrorParser\\RestJsonErrorParser', 'rest-xml' => 'WP_Cloud_Search\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'ec2' => 'WP_Cloud_Search\\Aws\\Api\\ErrorParser\\XmlErrorParser'];
    ...
    {
        static $mapping = ['json' => 'WP_Cloud_Search\\Aws\\Api\\Parser\\JsonRpcParser', 'query' => 'WP_Cloud_Search\\Aws\\Api\\Parser\\QueryParser', 'rest-json' => 'WP_Cloud_Search\\Aws\\Api\\Parser\\RestJsonParser', 'rest-xml' => 'WP_Cloud_Search\\Aws\\Api\\Parser\\RestXmlParser'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
