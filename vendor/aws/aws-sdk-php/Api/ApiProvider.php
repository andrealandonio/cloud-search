...
use WP_Cloud_Search\Aws\Exception\UnresolvedApiException;
/**
 * API providers.
 *
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \WP_Cloud_Search\Aws\manifest());
    }
    /**
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \WP_Cloud_Search\Aws\load_compiled_json($path);
