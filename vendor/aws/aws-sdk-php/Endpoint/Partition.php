...
use ArrayAccess;
use WP_Cloud_Search\Aws\HasDataTrait;
use WP_Cloud_Search\Aws\Sts\RegionalEndpoints\ConfigurationProvider;
use WP_Cloud_Search\Aws\S3\RegionalEndpoint\ConfigurationProvider as S3ConfigurationProvider;
