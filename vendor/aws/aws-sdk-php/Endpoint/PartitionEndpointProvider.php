...
namespace WP_Cloud_Search\Aws\Endpoint;

use WP_Cloud_Search\JmesPath\Env;
class PartitionEndpointProvider
{
    ...
    {
        $data = \WP_Cloud_Search\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \WP_Cloud_Search\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
