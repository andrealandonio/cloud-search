 ...
 */
namespace WP_Cloud_Search\Aws\CloudSearch;
...
use WP_Cloud_Search\Guzzle\Service\Resource\ResourceIteratorInterface;
/**
 ...
 */
class CloudSearchClient extends \WP_Cloud_Search\Aws\Common\Client\AbstractClient
{
    ...
    {
        return \WP_Cloud_Search\Aws\Common\Client\ClientBuilder::factory(__NAMESPACE__)->setConfig($config)->setConfigDefaults(array(\WP_Cloud_Search\Aws\Common\Enum\ClientOptions::VERSION => self::LATEST_API_VERSION, \WP_Cloud_Search\Aws\Common\Enum\ClientOptions::SERVICE_DESCRIPTION => __DIR__ . '/Resources/cloudsearch-%s.php'))->build();
    }
    /**
    ...
    public function getDomainClient($domainName, array $config = array())
    {
        ...
        return \WP_Cloud_Search\Aws\CloudSearchDomain\CloudSearchDomainClient::factory($config);
    }
}
