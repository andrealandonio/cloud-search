 ...
 */
namespace WP_Cloud_Search\Aws\Support;
 ...
 */
class SupportClient extends \WP_Cloud_Search\Aws\Common\Client\AbstractClient
{
    ...
    {
        return \WP_Cloud_Search\Aws\Common\Client\ClientBuilder::factory(__NAMESPACE__)->setConfig($config)->setConfigDefaults(array(\WP_Cloud_Search\Aws\Common\Enum\ClientOptions::VERSION => self::LATEST_API_VERSION, \WP_Cloud_Search\Aws\Common\Enum\ClientOptions::SERVICE_DESCRIPTION => __DIR__ . '/Resources/support-%s.php'))->setExceptionParser(new \WP_Cloud_Search\Aws\Common\Exception\Parser\JsonQueryExceptionParser())->build();
    }
}
