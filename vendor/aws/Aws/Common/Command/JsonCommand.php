 ...
 */
class JsonCommand extends \WP_Cloud_Search\Guzzle\Service\Command\OperationCommand
{
    /**
     * {@inheritdoc}
     */
    protected function build()
    {
        ...
        $this->request->getCurlOptions()->set(\WP_Cloud_Search\Guzzle\Http\Curl\CurlHandle::BODY_AS_STRING, \true);
    }
}
