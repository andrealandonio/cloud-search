 ...
 */
namespace WP_Cloud_Search\Aws\Common\Model\MultipartUpload;

use WP_Cloud_Search\Aws\Common\Client\AwsClientInterface;
use WP_Cloud_Search\Aws\Common\Exception\MultipartUploadException;
 ...
 */
abstract class AbstractTransfer extends \WP_Cloud_Search\Guzzle\Common\AbstractHasDispatcher implements \WP_Cloud_Search\Aws\Common\Model\MultipartUpload\TransferInterface
{
     ...
     */
    public function __construct(\WP_Cloud_Search\Aws\Common\Client\AwsClientInterface $client, \WP_Cloud_Search\Aws\Common\Model\MultipartUpload\TransferStateInterface $state, \WP_Cloud_Search\Guzzle\Http\EntityBody $source, array $options = array())
    {
        $this->client = $client;
        $this->state = $state;
        $this->source = $source;
    ...
    public function upload()
    {
        if ($this->state->isAborted()) {
            throw new \WP_Cloud_Search\Aws\Common\Exception\RuntimeException('The transfer has been aborted and cannot be uploaded');
        }
        $this->stopped = \false;
        ...
        try {
            ...
            throw new \WP_Cloud_Search\Aws\Common\Exception\MultipartUploadException($this->state, $e);
        }
        return $result;
    }
    /**
     ...
     * @return array
     */
    protected function getEventData(\WP_Cloud_Search\Guzzle\Service\Command\OperationCommand $command = null)
    {
