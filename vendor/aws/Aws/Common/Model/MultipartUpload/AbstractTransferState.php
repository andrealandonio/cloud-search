 ...
 */
abstract class AbstractTransferState implements \WP_Cloud_Search\Aws\Common\Model\MultipartUpload\TransferStateInterface
{
    /**
     ...
     */
    public function __construct(\WP_Cloud_Search\Aws\Common\Model\MultipartUpload\UploadIdInterface $uploadId)
    {
     ...
     * {@inheritdoc}
     */
    public function addPart(\WP_Cloud_Search\Aws\Common\Model\MultipartUpload\UploadPartInterface $part)
    {
    ...
    public function unserialize($serialized)
    {
        ...
        foreach (\get_object_vars($this) as $property => $oldValue) {
            if (\array_key_exists($property, $data)) {
                ...
                throw new \WP_Cloud_Search\Aws\Common\Exception\RuntimeException("The {$property} property could be restored during unserialization.");
            }
        }
    }
}
