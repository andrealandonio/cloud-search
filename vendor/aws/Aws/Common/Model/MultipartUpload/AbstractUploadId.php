 ...
 */
abstract class AbstractUploadId implements \WP_Cloud_Search\Aws\Common\Model\MultipartUpload\UploadIdInterface
{
    /**
    ...
    protected function loadData($data)
    {
        ...
        foreach ($data as $key => $value) {
            if (isset($data[$key])) {
                ...
                throw new \WP_Cloud_Search\Aws\Common\Exception\InvalidArgumentException("A required key [{$key}] was missing from the UploadId.");
            }
        }
    }
}
