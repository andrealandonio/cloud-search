...
interface TransferStateInterface extends \Countable, \IteratorAggregate, \Serializable
{
     ...
     * @return self
     */
    public static function fromUploadId(\WP_Cloud_Search\Aws\Common\Client\AwsClientInterface $client, \WP_Cloud_Search\Aws\Common\Model\MultipartUpload\UploadIdInterface $uploadId);
    /**
