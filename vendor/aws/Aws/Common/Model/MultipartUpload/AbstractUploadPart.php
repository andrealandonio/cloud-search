 ...
 */
abstract class AbstractUploadPart implements \WP_Cloud_Search\Aws\Common\Model\MultipartUpload\UploadPartInterface
{
    /**
    ...
    protected function loadData($data)
    {
        foreach (static::$keyMap as $key => $property) {
            if (isset($data[$key])) {
                ...
                throw new \WP_Cloud_Search\Aws\Common\Exception\InvalidArgumentException("A required key [{$key}] was missing from the upload part.");
            }
        }
    }
}
