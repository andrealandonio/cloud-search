 ...
 */
abstract class Facade implements \WP_Cloud_Search\Aws\Common\Facade\FacadeInterface
{
    /** @var Aws */
     ...
     */
    public static function mountFacades(\WP_Cloud_Search\Aws\Common\Aws $serviceBuilder, $targetNamespace = null)
    {
