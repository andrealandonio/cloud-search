 ...
 */
abstract class AbstractWaiter extends \WP_Cloud_Search\Guzzle\Common\AbstractHasDispatcher implements \WP_Cloud_Search\Aws\Common\Waiter\WaiterInterface
{
    ...
    public function wait()
    {
        ...
        do {
            ...
            if (++$this->attempts >= $this->getMaxAttempts()) {
                throw new \WP_Cloud_Search\Aws\Common\Exception\RuntimeException('Wait method never resolved to true after ' . $this->attempts . ' attempts');
            }
