 ...
 */
class WaiterClassFactory implements \WP_Cloud_Search\Aws\Common\Waiter\WaiterFactoryInterface
{
    /**
    ...
    public function build($waiter)
    {
        if (!($className = $this->getClassName($waiter))) {
            throw new \WP_Cloud_Search\Aws\Common\Exception\InvalidArgumentException("Waiter was not found matching {$waiter}.");
        }
