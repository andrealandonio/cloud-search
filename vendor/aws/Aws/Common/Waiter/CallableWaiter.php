 ...
 */
class CallableWaiter extends \WP_Cloud_Search\Aws\Common\Waiter\AbstractWaiter
{
    /**
    ...
    public function setCallable($callable)
    {
        if (!\is_callable($callable)) {
            throw new \WP_Cloud_Search\Aws\Common\Exception\InvalidArgumentException('Value is not callable');
        }
    ...
    {
        if (!$this->callable) {
            throw new \WP_Cloud_Search\Aws\Common\Exception\RuntimeException('No callable was specified for the wait method');
        }
