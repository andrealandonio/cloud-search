 ...
 */
namespace WP_Cloud_Search\Aws\Common;

use WP_Cloud_Search\Aws\Common\Facade\Facade;
use WP_Cloud_Search\Guzzle\Service\Builder\ServiceBuilder;
use WP_Cloud_Search\Guzzle\Service\Builder\ServiceBuilderLoader;
/**
 * Base class for interacting with web service clients
 */
class Aws extends \WP_Cloud_Search\Guzzle\Service\Builder\ServiceBuilder
{
    /**
    ...
    public static function factory($config = null, array $globalParameters = array())
    {
        ...
        $loader = new \WP_Cloud_Search\Guzzle\Service\Builder\ServiceBuilderLoader();
    ...
    {
        \WP_Cloud_Search\Aws\Common\Facade\Facade::mountFacades($this, $namespace);
        return $this;
    }
}
