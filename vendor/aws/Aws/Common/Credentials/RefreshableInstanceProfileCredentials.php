...
use WP_Cloud_Search\Aws\Common\InstanceMetadata\InstanceMetadataClient;
 ...
 * EC2 metadata server
 */
class RefreshableInstanceProfileCredentials extends \WP_Cloud_Search\Aws\Common\Credentials\AbstractRefreshableCredentials
{
    /**
     ...
     */
    public function __construct(\WP_Cloud_Search\Aws\Common\Credentials\CredentialsInterface $credentials, \WP_Cloud_Search\Aws\Common\InstanceMetadata\InstanceMetadataClient $client = null)
    {
        parent::__construct($credentials);
        $this->setClient($client);
    }
    public function setClient(\WP_Cloud_Search\Aws\Common\InstanceMetadata\InstanceMetadataClient $client = null)
    {
        $this->customClient = null !== $client;
        $this->client = $client ?: \WP_Cloud_Search\Aws\Common\InstanceMetadata\InstanceMetadataClient::factory();
    }
    ...
    {
        $serialized = \json_decode($value, \true);
        parent::unserialize($serialized['credentials']);
        $this->customClient = $serialized['customClient'];
        $this->client = $this->customClient ? \unserialize($serialized['client']) : \WP_Cloud_Search\Aws\Common\InstanceMetadata\InstanceMetadataClient::factory();
    }
    /**
