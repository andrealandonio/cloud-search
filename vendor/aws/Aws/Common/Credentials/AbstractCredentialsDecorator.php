 ...
 */
class AbstractCredentialsDecorator implements \WP_Cloud_Search\Aws\Common\Credentials\CredentialsInterface
{
    /**
     ...
     */
    public function __construct(\WP_Cloud_Search\Aws\Common\Credentials\CredentialsInterface $credentials)
    {
    ...
    {
        $this->credentials = new \WP_Cloud_Search\Aws\Common\Credentials\Credentials('', '');
