...
use WP_Cloud_Search\Aws\Common\Model\MultipartUpload\TransferStateInterface;
/**
 * Thrown when a {@see Aws\Common\MultipartUpload\TransferInterface} object encounters an error during transfer
 */
class MultipartUploadException extends \WP_Cloud_Search\Aws\Common\Exception\RuntimeException
{
    /**
     ...
     */
    public function __construct(\WP_Cloud_Search\Aws\Common\Model\MultipartUpload\TransferStateInterface $state, \Exception $exception = null)
    {
