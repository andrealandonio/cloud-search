 ...
 */
class DefaultClient extends \WP_Cloud_Search\Aws\Common\Client\AbstractClient
{
    /**
    ...
    {
        return \WP_Cloud_Search\Aws\Common\Client\ClientBuilder::factory()->setConfig($config)->setConfigDefaults(array(\WP_Cloud_Search\Aws\Common\Enum\ClientOptions::SCHEME => 'https'))->build();
    }
}
