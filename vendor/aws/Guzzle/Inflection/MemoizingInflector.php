 ...
 */
class MemoizingInflector implements \WP_Cloud_Search\Guzzle\Inflection\InflectorInterface
{
     ...
     */
    public function __construct(\WP_Cloud_Search\Guzzle\Inflection\InflectorInterface $inflector, $maxCacheSize = 500)
    {
