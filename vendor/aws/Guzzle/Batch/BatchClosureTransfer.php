 ...
 */
class BatchClosureTransfer implements \WP_Cloud_Search\Guzzle\Batch\BatchTransferInterface
{
    ...
    public function __construct($callable, $context = null)
    {
        if (!\is_callable($callable)) {
            throw new \WP_Cloud_Search\Guzzle\Common\Exception\InvalidArgumentException('Argument must be callable');
        }
