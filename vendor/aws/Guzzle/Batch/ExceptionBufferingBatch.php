 ...
 */
class ExceptionBufferingBatch extends \WP_Cloud_Search\Guzzle\Batch\AbstractBatchDecorator
{
    ...
    public function flush()
    {
        ...
        while (!$this->decoratedBatch->isEmpty()) {
            ...
            } catch (\WP_Cloud_Search\Guzzle\Batch\Exception\BatchTransferException $e) {
                $this->exceptions[] = $e;
