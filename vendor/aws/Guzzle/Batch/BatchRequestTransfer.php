 ...
 */
class BatchRequestTransfer implements \WP_Cloud_Search\Guzzle\Batch\BatchTransferInterface, \WP_Cloud_Search\Guzzle\Batch\BatchDivisorInterface
{
    ...
    public function createBatches(\SplQueue $queue)
    {
        ...
        foreach ($queue as $item) {
            if (!$item instanceof \WP_Cloud_Search\Guzzle\Http\Message\RequestInterface) {
                throw new \WP_Cloud_Search\Guzzle\Common\Exception\InvalidArgumentException('WP_Cloud_Search\\All items must implement Guzzle\\Http\\Message\\RequestInterface');
            }
