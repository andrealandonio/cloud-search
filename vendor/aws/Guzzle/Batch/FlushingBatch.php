 ...
 */
class FlushingBatch extends \WP_Cloud_Search\Guzzle\Batch\AbstractBatchDecorator
{
     ...
     */
    public function __construct(\WP_Cloud_Search\Guzzle\Batch\BatchInterface $decoratedBatch, $threshold)
    {
