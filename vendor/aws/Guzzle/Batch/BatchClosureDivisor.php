 ...
 */
class BatchClosureDivisor implements \WP_Cloud_Search\Guzzle\Batch\BatchDivisorInterface
{
    ...
    public function __construct($callable, $context = null)
    {
        if (!\is_callable($callable)) {
            throw new \WP_Cloud_Search\Guzzle\Common\Exception\InvalidArgumentException('Must pass a callable');
        }
