...
use WP_Cloud_Search\Guzzle\Batch\Exception\BatchTransferException;
/**
 ...
 */
class Batch implements \WP_Cloud_Search\Guzzle\Batch\BatchInterface
{
     ...
     */
    public function __construct(\WP_Cloud_Search\Guzzle\Batch\BatchTransferInterface $transferStrategy, \WP_Cloud_Search\Guzzle\Batch\BatchDivisorInterface $divisionStrategy)
    {
        ...
        foreach ($this->dividedBatches as $batchIndex => $dividedBatch) {
            while ($dividedBatch->valid()) {
                ...
                try {
                    ...
                    throw new \WP_Cloud_Search\Guzzle\Batch\Exception\BatchTransferException($batch, $items, $e, $this->transferStrategy, $this->divisionStrategy);
                }
            }
