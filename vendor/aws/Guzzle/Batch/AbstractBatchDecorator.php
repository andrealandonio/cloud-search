 ...
 */
abstract class AbstractBatchDecorator implements \WP_Cloud_Search\Guzzle\Batch\BatchInterface
{
     ...
     */
    public function __construct(\WP_Cloud_Search\Guzzle\Batch\BatchInterface $decoratedBatch)
    {
