 ...
 */
class BackoffLogger implements \WP_Cloud_Search\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
     ...
     */
    public function __construct(\WP_Cloud_Search\Guzzle\Log\LogAdapterInterface $logger, \WP_Cloud_Search\Guzzle\Log\MessageFormatter $formatter = null)
    {
        $this->logger = $logger;
        $this->formatter = $formatter ?: new \WP_Cloud_Search\Guzzle\Log\MessageFormatter(self::DEFAULT_FORMAT);
    }
    public static function getSubscribedEvents()
    {
        return array(\WP_Cloud_Search\Guzzle\Plugin\Backoff\BackoffPlugin::RETRY_EVENT => 'onRequestRetry');
    }
    /**
     ...
     */
    public function onRequestRetry(\WP_Cloud_Search\Guzzle\Common\Event $event)
    {
