 ...
 */
abstract class AbstractBackoffStrategy implements \WP_Cloud_Search\Guzzle\Plugin\Backoff\BackoffStrategyInterface
{
    /** @var AbstractBackoffStrategy Next strategy in the chain */
    protected $next;
    /** @param AbstractBackoffStrategy $next Next strategy in the chain */
    public function setNext(\WP_Cloud_Search\Guzzle\Plugin\Backoff\AbstractBackoffStrategy $next)
    {
        $this->next = $next;
    }
    /**
    ...
    public function getBackoffPeriod($retries, \WP_Cloud_Search\Guzzle\Http\Message\RequestInterface $request, \WP_Cloud_Search\Guzzle\Http\Message\Response $response = null, \WP_Cloud_Search\Guzzle\Http\Exception\HttpException $e = null)
    {
     ...
     * @return bool
     */
    public abstract function makesDecision();
    /**
     ...
     */
    protected abstract function getDelay($retries, \WP_Cloud_Search\Guzzle\Http\Message\RequestInterface $request, \WP_Cloud_Search\Guzzle\Http\Message\Response $response = null, \WP_Cloud_Search\Guzzle\Http\Exception\HttpException $e = null);
}
