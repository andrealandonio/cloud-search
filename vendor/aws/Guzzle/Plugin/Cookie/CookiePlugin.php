...
namespace WP_Cloud_Search\Guzzle\Plugin\Cookie;

use WP_Cloud_Search\Guzzle\Common\Event;
use WP_Cloud_Search\Guzzle\Plugin\Cookie\CookieJar\ArrayCookieJar;
use WP_Cloud_Search\Guzzle\Plugin\Cookie\CookieJar\CookieJarInterface;
use WP_Cloud_Search\Symfony\Component\EventDispatcher\EventSubscriberInterface;
/**
 * Adds, extracts, and persists cookies between HTTP requests
 */
class CookiePlugin implements \WP_Cloud_Search\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
     ...
     */
    public function __construct(\WP_Cloud_Search\Guzzle\Plugin\Cookie\CookieJar\CookieJarInterface $cookieJar = null)
    {
        $this->cookieJar = $cookieJar ?: new \WP_Cloud_Search\Guzzle\Plugin\Cookie\CookieJar\ArrayCookieJar();
    }
