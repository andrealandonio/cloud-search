...
namespace WP_Cloud_Search\Guzzle\Common\Exception;

/**
 * Collection of exceptions
 */
class ExceptionCollection extends \Exception implements \WP_Cloud_Search\Guzzle\Common\Exception\GuzzleException, \IteratorAggregate, \Countable
{
