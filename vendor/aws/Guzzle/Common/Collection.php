 ...
 */
class Collection implements \ArrayAccess, \IteratorAggregate, \Countable, \WP_Cloud_Search\Guzzle\Common\ToArrayInterface
{
    ...
    public static function fromConfig(array $config = array(), array $defaults = array(), array $required = array())
    {
        ...
        if ($missing = \array_diff($required, \array_keys($data))) {
            throw new \WP_Cloud_Search\Guzzle\Common\Exception\InvalidArgumentException('Config is missing the following keys: ' . \implode(', ', $missing));
        }
    ...
    public function overwriteWith($data)
    {
        ...
        } elseif ($data instanceof \WP_Cloud_Search\Guzzle\Common\Collection) {
     ...
     * @return Collection
     */
    public function map(\Closure $closure, array $context = array(), $static = \true)
    {
     ...
     * @return Collection
     */
    public function filter(\Closure $closure, $static = \true)
    {
        $collection = $static ? new static() : new self();
    ...
    public function setPath($path, $value)
    {
        ...
        while (null !== ($key = \array_shift($queue))) {
            if (!\is_array($current)) {
                throw new \WP_Cloud_Search\Guzzle\Common\Exception\RuntimeException("Trying to setPath {$path}, but {$key} is set and is not an array");
            } elseif (!$queue) {
                $current[$key] = $value;
