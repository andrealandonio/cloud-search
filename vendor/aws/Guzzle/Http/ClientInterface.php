 ...
 */
interface ClientInterface extends \WP_Cloud_Search\Guzzle\Common\HasDispatcherInterface
{
    const CREATE_REQUEST = 'client.create_request';
    /** @var string RFC 1123 HTTP-Date */
    const HTTP_DATE = 'WP_Cloud_Search\\D, d M Y H:i:s \\G\\M\\T';
    /**
     ...
     */
    public function createRequest($method = \WP_Cloud_Search\Guzzle\Http\Message\RequestInterface::GET, $uri = null, $headers = null, $body = null, array $options = array());
    /**
     ...
     * @return self
     */
    public function setSslVerification($certificateAuthority = \true, $verifyPeer = \true, $verifyHost = 2);
}
