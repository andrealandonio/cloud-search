...
use WP_Cloud_Search\Guzzle\Stream\StreamInterface;
/**
 * EntityBody decorator used to return only a subset of an entity body
 */
class ReadLimitEntityBody extends \WP_Cloud_Search\Guzzle\Http\AbstractEntityBodyDecorator
{
     ...
     */
    public function __construct(\WP_Cloud_Search\Guzzle\Http\EntityBodyInterface $body, $limit, $offset = 0)
    {
