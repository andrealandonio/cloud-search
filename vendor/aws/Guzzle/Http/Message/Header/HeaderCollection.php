 ...
 */
class HeaderCollection implements \IteratorAggregate, \Countable, \ArrayAccess, \WP_Cloud_Search\Guzzle\Common\ToArrayInterface
{
    /** @var array */
    protected $headers;
     ...
     * @return self
     */
    public function add(\WP_Cloud_Search\Guzzle\Http\Message\Header\HeaderInterface $header)
    {
