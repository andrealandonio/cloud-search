 ...
 * POST file upload
 */
class PostFile implements \WP_Cloud_Search\Guzzle\Http\Message\PostFileInterface
{
    protected $fieldName;
    ...
    {
        \WP_Cloud_Search\Guzzle\Common\Version::warn(__METHOD__ . ' is deprecated. Use getCurlValue()');
    ...
    {
        return \WP_Cloud_Search\Guzzle\Http\Mimetypes::getInstance()->fromFilename($this->filename) ?: 'application/octet-stream';
    }
}
