 ...
 */
class Header implements \WP_Cloud_Search\Guzzle\Http\Message\Header\HeaderInterface
{
    ...
    public function raw()
    {
        \WP_Cloud_Search\Guzzle\Common\Version::warn(__METHOD__ . ' is deprecated. Use toArray()');
        return $this->toArray();
    }
    /**
