 ...
 */
class AbstractEntityBodyDecorator implements \WP_Cloud_Search\Guzzle\Http\EntityBodyInterface
{
    ...
    {
        $hash = \WP_Cloud_Search\Guzzle\Stream\Stream::getHash($this, 'md5', $rawOutput);
