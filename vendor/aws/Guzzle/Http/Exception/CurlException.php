 ...
 */
class CurlException extends \WP_Cloud_Search\Guzzle\Http\Exception\RequestException
{
    private $curlError;
    private $curlErrorNo;
    private $handle;
     ...
     * @return self
     */
    public function setCurlHandle(\WP_Cloud_Search\Guzzle\Http\Curl\CurlHandle $handle)
    {
        $this->handle = $handle;
        return $this;
    }
