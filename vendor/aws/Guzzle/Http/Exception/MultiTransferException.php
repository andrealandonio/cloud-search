 ...
 */
class MultiTransferException extends \WP_Cloud_Search\Guzzle\Common\Exception\ExceptionCollection
{
     ...
     * @return self
     */
    public function addSuccessfulRequest(\WP_Cloud_Search\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return self
     */
    public function addFailedRequest(\WP_Cloud_Search\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return self
     */
    public function addFailedRequestWithException(\WP_Cloud_Search\Guzzle\Http\Message\RequestInterface $request, \Exception $exception)
    {
     ...
     */
    public function getExceptionForFailedRequest(\WP_Cloud_Search\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return bool
     */
    public function containsRequest(\WP_Cloud_Search\Guzzle\Http\Message\RequestInterface $request)
    {
        return \in_array($request, $this->failedRequests, \true) || \in_array($request, $this->successfulRequests, \true);
    }
}
