 ...
 */
class XmlVisitor extends \WP_Cloud_Search\Guzzle\Service\Command\LocationVisitor\Response\AbstractResponseVisitor
{
    public function before(\WP_Cloud_Search\Guzzle\Service\Command\CommandInterface $command, array &$result)
    {
        ...
        $result = \json_decode(\json_encode($command->getResponse()->xml()), \true);
    }
     ...
     */
    protected function processArray(\WP_Cloud_Search\Guzzle\Service\Description\Parameter $param, &$value)
    {
     ...
     * @param mixed     $value Value to process
     */
    protected function processObject(\WP_Cloud_Search\Guzzle\Service\Description\Parameter $param, &$value)
    {
     ...
     */
    protected function processXmlAttribute(\WP_Cloud_Search\Guzzle\Service\Description\Parameter $property, array &$value)
    {
        $sentAs = $property->getWireName();
