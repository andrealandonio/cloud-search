 ...
 */
class XmlVisitor extends \WP_Cloud_Search\Guzzle\Service\Command\LocationVisitor\Request\AbstractRequestVisitor
{
     ...
     * @return \XMLWriter
     */
    protected function createRootElement(\WP_Cloud_Search\Guzzle\Service\Description\Operation $operation)
    {
     ...
     */
    protected function addXml(\XMLWriter $xmlWriter, \WP_Cloud_Search\Guzzle\Service\Description\Parameter $param, $value)
    {
        if ($value === null) {
            return;
        }
     ...
     */
    protected function addXmlArray(\XMLWriter $xmlWriter, \WP_Cloud_Search\Guzzle\Service\Description\Parameter $param, &$value)
    {
     ...
     */
    protected function addXmlObject(\XMLWriter $xmlWriter, \WP_Cloud_Search\Guzzle\Service\Description\Parameter $param, &$value)
    {
        $noAttributes = array();
