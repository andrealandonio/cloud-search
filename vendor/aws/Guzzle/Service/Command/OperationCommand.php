 ...
 */
class OperationCommand extends \WP_Cloud_Search\Guzzle\Service\Command\AbstractCommand
{
     ...
     * @return self
     */
    public function setResponseParser(\WP_Cloud_Search\Guzzle\Service\Command\ResponseParserInterface $parser)
    {
     ...
     * @return self
     */
    public function setRequestSerializer(\WP_Cloud_Search\Guzzle\Service\Command\RequestSerializerInterface $serializer)
    {
    ...
    public function getRequestSerializer()
    {
        if (!$this->requestSerializer) {
            ...
            $this->requestSerializer = \WP_Cloud_Search\Guzzle\Service\Command\DefaultRequestSerializer::getInstance();
        }
    ...
    public function getResponseParser()
    {
        if (!$this->responseParser) {
            ...
            $this->responseParser = \WP_Cloud_Search\Guzzle\Service\Command\OperationResponseParser::getInstance();
        }
