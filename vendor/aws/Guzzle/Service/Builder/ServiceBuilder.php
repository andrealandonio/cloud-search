...
namespace WP_Cloud_Search\Guzzle\Service\Builder;

use WP_Cloud_Search\Guzzle\Common\AbstractHasDispatcher;
use WP_Cloud_Search\Guzzle\Service\ClientInterface;
use WP_Cloud_Search\Guzzle\Service\Exception\ServiceBuilderException;
use WP_Cloud_Search\Guzzle\Service\Exception\ServiceNotFoundException;
 ...
 */
class ServiceBuilder extends \WP_Cloud_Search\Guzzle\Common\AbstractHasDispatcher implements \WP_Cloud_Search\Guzzle\Service\Builder\ServiceBuilderInterface, \ArrayAccess, \Serializable
{
    ...
    public static function factory($config = null, array $globalParameters = array())
    {
        ...
        if (!static::$cachedFactory) {
            static::$cachedFactory = new \WP_Cloud_Search\Guzzle\Service\Builder\ServiceBuilderLoader();
        }
    ...
    {
        $this->builderConfig = \json_decode($serialized, \true);
    }
     ...
     * @return self
     */
    public function addGlobalPlugin(\WP_Cloud_Search\Symfony\Component\EventDispatcher\EventSubscriberInterface $plugin)
    {
        $this->plugins[] = $plugin;
        return $this;
    }
    ...
    public function get($name, $throwAway = \false)
    {
        if (!isset($this->builderConfig[$name])) {
            ...
            throw new \WP_Cloud_Search\Guzzle\Service\Exception\ServiceNotFoundException('No service is registered as ' . $name);
        }
        ...
        if ($client instanceof \WP_Cloud_Search\Guzzle\Service\ClientInterface) {
