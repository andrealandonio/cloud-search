 ...
 */
class ServiceBuilderLoader extends \WP_Cloud_Search\Guzzle\Service\AbstractConfigLoader
{
        ...
        foreach ($services as $name => &$service) {
            ...
            if (!empty($service['extends'])) {
                ...
                if (!isset($services[$service['extends']])) {
                    throw new \WP_Cloud_Search\Guzzle\Service\Exception\ServiceNotFoundException("{$name} is trying to extend a non-existent service: {$service['extends']}");
                }
