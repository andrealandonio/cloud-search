...
class SchemaFormatter
{
    ...
    {
        return self::dateFormatter($value, 'WP_Cloud_Search\\Y-m-d\\TH:i:s\\Z');
    }
    /**
    ...
    {
        return self::dateFormatter($value, 'WP_Cloud_Search\\D, d M Y H:i:s \\G\\M\\T');
    }
    /**
    ...
    protected static function dateFormatter($dateTime, $format)
    {
        ...
        throw new \WP_Cloud_Search\Guzzle\Common\Exception\InvalidArgumentException('Date/Time values must be either a string, integer, or DateTime object');
    }
}
