 ...
 */
class CommandTransferException extends \WP_Cloud_Search\Guzzle\Http\Exception\MultiTransferException
{
     ...
     * @return self
     */
    public static function fromMultiTransferException(\WP_Cloud_Search\Guzzle\Http\Exception\MultiTransferException $e)
    {
     ...
     * @return self
     */
    public function addSuccessfulCommand(\WP_Cloud_Search\Guzzle\Service\Command\CommandInterface $command)
    {
     ...
     * @return self
     */
    public function addFailedCommand(\WP_Cloud_Search\Guzzle\Service\Command\CommandInterface $command)
    {
     ...
     */
    public function getExceptionForFailedCommand(\WP_Cloud_Search\Guzzle\Service\Command\CommandInterface $command)
    {
