 ...
 */
class ResourceIteratorClassFactory extends \WP_Cloud_Search\Guzzle\Service\Resource\AbstractResourceIteratorFactory
{
     ...
     */
    public function __construct($namespaces = array(), \WP_Cloud_Search\Guzzle\Inflection\InflectorInterface $inflector = null)
    {
    ...
    protected function getClassName(\WP_Cloud_Search\Guzzle\Service\Command\CommandInterface $command)
    {
