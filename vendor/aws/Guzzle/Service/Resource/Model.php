 ...
 */
class Model extends \WP_Cloud_Search\Guzzle\Common\Collection
{
     ...
     */
    public function __construct(array $data = array(), \WP_Cloud_Search\Guzzle\Service\Description\Parameter $structure = null)
    {
        $this->data = $data;
    ...
    {
        return $this->structure ?: new \WP_Cloud_Search\Guzzle\Service\Description\Parameter();
    }
    /**
    ...
    public function __toString()
    {
        ...
        $lines = \array_slice(\explode("\n", \trim(\print_r($this->toArray(), \true))), 2, -1);
        $output .= \implode("\n", $lines);
        if ($this->structure) {
            $output .= "\n\nModel structure\n---------------\n\n";
