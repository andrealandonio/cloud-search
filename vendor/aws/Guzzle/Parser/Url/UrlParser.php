...
namespace WP_Cloud_Search\Guzzle\Parser\Url;
 ...
 * @codeCoverageIgnore
 */
class UrlParser implements \WP_Cloud_Search\Guzzle\Parser\Url\UrlParserInterface
{
    ...
    {
        \WP_Cloud_Search\Guzzle\Common\Version::warn(__CLASS__ . ' is deprecated. Just use parse_url()');
