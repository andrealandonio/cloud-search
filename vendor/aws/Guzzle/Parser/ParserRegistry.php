...
namespace WP_Cloud_Search\Guzzle\Parser;
...
class ParserRegistry
{
    ...
    protected $mapping = array('message' => 'WP_Cloud_Search\\Guzzle\\Parser\\Message\\MessageParser', 'cookie' => 'WP_Cloud_Search\\Guzzle\\Parser\\Cookie\\CookieParser', 'url' => 'WP_Cloud_Search\\Guzzle\\Parser\\Url\\UrlParser', 'uri_template' => 'WP_Cloud_Search\\Guzzle\\Parser\\UriTemplate\\UriTemplate');
    /**
     * @return self
     * @codeCoverageIgnore
     */
    ...
    public function __construct()
    {
        ...
        if (\extension_loaded('uri_template')) {
            $this->mapping['uri_template'] = 'WP_Cloud_Search\\Guzzle\\Parser\\UriTemplate\\PeclUriTemplate';
        }
    }
    /**
