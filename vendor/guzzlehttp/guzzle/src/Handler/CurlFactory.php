...
namespace WP_Cloud_Search\GuzzleHttp\Handler;

use WP_Cloud_Search\GuzzleHttp\Exception\ConnectException;
use WP_Cloud_Search\GuzzleHttp\Exception\RequestException;
use WP_Cloud_Search\GuzzleHttp\Promise as P;
use WP_Cloud_Search\GuzzleHttp\Promise\FulfilledPromise;
use WP_Cloud_Search\GuzzleHttp\Promise\PromiseInterface;
use WP_Cloud_Search\GuzzleHttp\Psr7\LazyOpenStream;
use WP_Cloud_Search\GuzzleHttp\TransferStats;
use WP_Cloud_Search\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \WP_Cloud_Search\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \WP_Cloud_Search\GuzzleHttp\Psr7\Utils::streamFor($sink);
