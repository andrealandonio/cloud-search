...
use WP_Cloud_Search\GuzzleHttp\Cookie\CookieJar;
use WP_Cloud_Search\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \WP_Cloud_Search\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
